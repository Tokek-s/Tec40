...
<template>
    <AdminLayout>
        <Head title="Nuevo Formulario Externo" />

        <div class="max-w-4xl mx-auto py-6">
            <div class="flex items-center justify-between mb-6">
                <h2 class="text-2xl font-bold text-gray-800">Nuevo Formulario Externo</h2>
                ...
                <form @submit.prevent="submit" class="p-6 space-y-6">
                    ...
                    <div class="grid grid-cols-1 gap-6">
                        <div>
                            ...
                            <input id="titulo" v-model="form.titulo" type="text" required
                                ...
                                placeholder="Ej. Inscripciones 2025" />
                        ...
                        <div>
                            ...
                            <textarea id="descripcion" v-model="form.descripcion" rows="3"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm text-gray-900"
                                placeholder="Breve descripción del propósito de este formulario..."></textarea>
                    ...
                    <div class="flex justify-end space-x-3 pt-4">
                        ...
                        <button type="submit" :disabled="form.processing"
                            ...
                            {{ form.processing ? 'Guardando...' : 'Crear Formulario' }}
                        </button>
                    </div>
                </form>
            </div>
